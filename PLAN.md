...
| 3 | **Petnix** | The only thing here that is genuinely *shipped* — App Store track, real schema, E2E suite gating builds. Product engineering, not a demo. | Screenshots or a 20s screen recording. Decide if `PetPal` goes public. Live link already exists: petnix.app (petpal.app is a parking page). |
